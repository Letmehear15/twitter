...
const Home:FC = ():ReactElement => {
    ...
    // TODO: добавлнение твита, если ошибка, то выписать ошибку, сделать отдельное состояние загрузки
            ...
            <Grid  container spacing={3}>
                ...
                <Grid item xs={6}>
                    <Paper variant="outlined" className={classes.mainWrapper}>
                        ...
                        <div style={{height:10, width:'100%', backgroundColor:"#E6ECF0"}}></div>
                ...
                <Grid item xs={3}>
                    <div className={classes.rightSide}>
                        <SearchTextField 
                            fullWidth placeholder="Search Twitter"
                            variant="outlined"
                            InputProps={{
                                startAdornment: (
